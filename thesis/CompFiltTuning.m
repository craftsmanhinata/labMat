...
figure();
 ...
 ylabel('Angle speed(rad/sec.)','FontSize',FontSize);
 title('Roll angle speed','FontSize',FontSize);
 set(gca,'FontSize',FontSize);
 ...
 ylabel('Angle speed(rad/sec.)','FontSize',FontSize);
 set(gca,'FontSize',FontSize);
  title('Pitch angle speed','FontSize',FontSize);
 axYaw = subplot(3,1,3);
 plot(time,yawSpeed(:,bestCutoffIndex));
 xlabel('Time(sec.)','FontSize',FontSize);
 ylabel('Angle speed(rad/sec.)','FontSize',FontSize);
 set(gca,'FontSize',FontSize);
   title('Yaw angle speed','FontSize',FontSize);
